...
//----------------------------------------------------------------------------
StringMessage1::StringMessage1() : MessageBase()
{
...
//----------------------------------------------------------------------------
StringMessage1::~StringMessage1()
{

}

//----------------------------------------------------------------------------
int StringMessage1::SetString( const char *string )
{
...
//----------------------------------------------------------------------------
int StringMessage1::SetString( std::string &string )
{
  this->m_String = string;
  return (int) this->m_String.length();
}
...
//----------------------------------------------------------------------------
const char* StringMessage1::GetString()
{
  return this->m_String.c_str();
}

//----------------------------------------------------------------------------
int StringMessage1::GetBodyPackSize()
{
  return sizeof( igtl_uint16 ) + this->m_String.length();
}

//----------------------------------------------------------------------------
int StringMessage1::PackBody()
{
  AllocatePack();
